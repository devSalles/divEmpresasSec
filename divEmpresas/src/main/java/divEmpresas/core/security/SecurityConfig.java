    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity)
    {
        return httpSecurity.csrf(csrf->csrf.disable())
                ...
                .authorizeHttpRequests(authorize-> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,"/user/buscar-proprio-perfil/**").hasAnyRole("ADMIN","MANAGER","USER")
                        .requestMatchers(HttpMethod.GET,"/user/listar-todos").hasAnyRole("ADMIN","MANAGER","USER")
                        .requestMatchers(HttpMethod.DELETE,"/user/deletar-colaborador/**").hasAnyRole("ADMIN","MANAGER")
